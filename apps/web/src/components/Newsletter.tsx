...
export function Newsletter(): JSX.Element {
  return (
    <form
      action={`https://app.convertkit.com/forms/${clientConfig.convertKitFormId}/subscriptions`}
      method="post"
    >
      <Box
        display="grid"
        ...
        borderRadius="lg"
      >
        <Stack p={{ base: '7', sm: '14' }} background="gray.50">
          <Text fontSize="lg" fontWeight="bold" lineHeight="6">
            Subscribe to the Newsletter
          </Text>
          <Text fontSize="sm">
            {`My name's Nick and I'm a software engineer writing about the tech side of B2B SaaS`}
          </Text>
        ...
        <Stack p={{ base: '7', sm: '14' }} spacing="3">
          <Stack>
            <Input
          ...
          <Box>
            <Text fontSize="xs" color="muted">{`I won't send you spam.`}</Text>
